...
# Configuration Script – SMTBMNEU868 - Rev. B

This **Configuration** script is designed for the **SMTBMNEU868** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – SMTBMNEU868 Rev. B

Este script de **Configuration** está diseñado para el modelo **SMTBMNEU868** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
